...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_PLUGIN_EXTENSION_HPP_INCLUDED
#define ZEN_PLUGIN_EXTENSION_HPP_INCLUDED

#include "../Configuration.hpp"

#include <Zen/PluginI_Extension.hpp>
...
#endif // ZEN_PLUGIN_EXTENSION_HPP_INCLUDED
